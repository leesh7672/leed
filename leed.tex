...
\hanjabyhanjafont=1
\setmainfont[InterCharStretch=3pt,Vertical=Alternates,RawFeature=vertical]{HCR Batang Lvt}
...
\newcommand{\entry}[4]{\par\textcolor{gold}{#1}\textsuperscript{\rotatebox{90}{\fontface{HCR Batang Lvt}{#2}}} {#3}}
